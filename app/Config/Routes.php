...
$routes->post('/login/control', 'Authentication::login');
$routes->post('/register/control', 'Authentication::register');
$routes->post('/send-reset-password', 'Authentication::send_reset_password');
